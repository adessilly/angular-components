...
export class ModalComponent {
    ...
    constructor(sharedService: SharedService,
        ...
        sharedService.showModal.subscribe(msg => {
            ...
            // Ajout des différents listes des codifications à l'objet data utilisé dans le composant
            // qui définit le body de la modal (le formulaire)
            ...
            // Copier la référence de l'objet contenant les données du formulaire.
            // Cet objet sera mis à jour si l'utilisateur Valide les modifications.
    ...
    validate() {
        if (this.cmpRef) {
            ...
            if (this.updateOriginalDataFunction) {
                ...
                if (this.cmpRef.instance.onValidated) {
                    this.cmpRef.instance.onValidated.emit(this.cmpRef.instance);
                }
            }
            this.cmpRef.destroy();
        }
